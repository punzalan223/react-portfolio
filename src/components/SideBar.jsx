                    ...
                    <div className="p-5 bg-white/95">
                        <div className="flex items-center gap-4 sm:gap-8">
                            ...
                            <div className="flex flex-col justify-center py-5">
                                ...
                                <p className="text-gray-700 text-opacity-75">Software Engineer</p>
                                <div className="flex gap-2 mt-1">
                                    ...
                                    <a href="https://www.linkedin.com/in/patrick-lester-punzalan-077546243/" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                                            <path fill="#0A66C2" d="M100.28 448H7.4V148.9h92.88zm-46.44-341C24.08 107 0 82.81 0 54.89A53.82 53.82 0 0 1 53.83 0c29.75 0 53.83 24.08 53.83 54.88 0 27.93-24.08 52.11-53.82 52.11zm394.2 341h-92.68V302.4c0-34.7-12.45-58.4-43.63-58.4-23.8 0-38 16-44.3 31.5-2.28 5.5-2.85 13.1-2.85 20.8V448h-92.68s1.24-259.1 0-285.1h92.68v40.4c-.18.3-.43.7-.61 1h.61v-1c12.3-19 34.3-46.1 83.3-46.1 60.8 0 106.5 39.8 106.5 125.4V448z"/>
                                        </svg>
                                    </a>
                                </div>
                            </div>
